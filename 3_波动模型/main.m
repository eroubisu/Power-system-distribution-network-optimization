...
figure(2)
t = 1:1:24;
plot(t, UP_P_ess_dch_plan(1, :) - UP_P_ess_ch_plan(1, :), '--', 'linewidth', 2);
hold on
plot(t, UP_P_ess_dch_plan(2, :) - UP_P_ess_ch_plan(2, :), '-*', 'linewidth', 2);
xlabel('时刻/h');
ylabel('储能出力')
legend('ESS1', 'ESS2');
...
figure(5)
t = 1:1:24;
plot(t, sum(UP_P_wt_fluc), '--k', 'linewidth', 2);
hold on
plot(t, sum(UP_Q_wt_fluc), '-*k', 'linewidth', 2);
hold on
plot(t, sum(UP_P_pv_fluc), '--r', 'linewidth', 2);
xlabel('时刻/h');
ylabel('新能源出力')
legend('风电有功', '风电无功', '光伏有功');
...
figure(8)
t = 1:1:24;
plot(t, P_Gen_fluc(69, :), '--', 'linewidth', 1.6);
hold on
plot(t, Q_Gen_fluc(69, :), '-*', 'linewidth', 1.6);
xlabel('时刻/h');
ylabel('机组出力');
legend('Pg', 'Qg');
...
figure(9)
t = 1:1:24;
plot(t, UP_P_load_sd_fluc(1, :) ./ Pre_P_Load(mpc.load_sd(1, 1), :), '--', 'linewidth', 2);
hold on
plot(t, UP_P_load_sd_fluc(2, :) ./ Pre_P_Load(mpc.load_sd(2, 1), :), '-*', 'linewidth', 2);
xlabel('时刻/h');
ylabel('负荷削减');
...
figure(10)
t = 1:1:24;
plot(t, P_Gen_plan(69, :), '--k', 'linewidth', 1.6);
hold on
plot(t, P_Gen_fluc(69, :), '--r', 'linewidth', 1.6);
xlabel('时刻/h');
ylabel('机组出力比较');
legend('P_{Gen,plan}', 'P_{Gen,fluc}');
